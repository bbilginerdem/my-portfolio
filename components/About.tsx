    ...
    return (
        ...
        >
            ...
            <p className="mb-3">
                ...
                pursue my passion for programming. I started working in a
                company as an intern and learned{" "}
